...
const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    body: [
      ...
      "Voor wie Bohèm nog niet kent, is Vroeger een heldere eerste kennismaking. Het laat horen hoe het duo werkt: melodisch, persoonlijk en met genoeg ruimte voor wat niet meteen wordt uitgelegd. Juist daardoor blijft het nummer niet hangen als een losse release, maar als een lied dat nieuwsgierig maakt naar wat er live en op de komende plaat nog meer aankomt."
    ],
    image: {
  ...
  },
  {
    ...
    body: [
      ...
      "Dat maakt deze middag meer dan een datum in de agenda. Het is het moment waarop nieuwe muziek, live-presentatie en samenwerking samen zichtbaar worden voor publiek dat Bohèm misschien al volgt, maar ook voor mensen die het duo juist voor het eerst in een zaal meemaken.",
      "Wie erbij wil zijn, vindt via de eventpagina de praktische informatie. Wie eerst beter wil aanvoelen waar Bohèm muzikaal voor staat, kan vanuit deze show gemakkelijk verder luisteren, kijken of lezen. In die zin voelt deze release-middag als een natuurlijk startpunt voor de volgende fase van het project."
    ],
    image: {
  ...
  },
  {
    ...
    body: [
      ...
      "Deze Tilburg-datum laat goed zien wat Bohèm live kan zijn: persoonlijk, professioneel en geschikt voor settings waar een optreden iets mag openen in plaats van alleen iets opvullen. Voor wie benieuwd is naar het duo in een aandachtige omgeving, is dit precies zo'n middag waarop de vorm van dichtbij te ervaren is."
    ],
    image: {
      src: "/images/bohem-hero.jpg",
      alt: "Arthur Bont en Bettina Kraaieveld in warm podiumlicht",
  ...
  },
  {
    ...
    body: [
      ...
      "Voor wie Bohèm programmeert, is Reizigers daarom een bruikbaar referentiepunt. Het maakt zichtbaar dat er achter het duo een duidelijke live-identiteit schuilt: niet alleen liedjes en sfeer, maar een programma met lijn. Voor bezoekers helpt het vooral om te begrijpen wat ze mogen verwachten als ze Bohèm live gaan zien."
    ],
    image: {
      src: "/images/bohem-hero.jpg",
      alt: "Arthur Bont en Bettina Kraaieveld in warm podiumlicht",
  ...
  },
  {
    ...
    body: [
      "Wie Bohèm snel goed wil plaatsen, zoekt meestal niet alleen een korte bio of één foto, maar vooral context. Wat voor duo is dit? In welke setting werkt het sterk? Waar sluit het live op aan? En hoe kom je snel bij het juiste materiaal of contactpunt uit? Juist daarom is het prettig als pers en programmeerinfo niet versnipperd raakt, maar op één plek samenkomt.",
      "Bohèm beweegt zich in een vrij specifieke ruimte: liedjes met verhaal, directe podiumpresentatie en een vorm die goed landt in luisterende en culturele settings. Daardoor helpt het als programmeurs meteen kunnen zien welke ingang het meest logisch is. Soms is dat de algemene duo-pagina, soms juist een luisterconcert, soms een culturele event-context.",
      "Ook voor redacties is zo'n heldere context handig. Een externe agenda noemt vaak wel datum, locatie en een korte beschrijving, maar laat minder zien hoe releases, live-programma en boekingsroutes met elkaar samenhangen. Als die lijn wel zichtbaar is, wordt het eenvoudiger om een aankondiging, intro of programmatekst te schrijven die echt klopt.",
      "De perspagina blijft daarbij het vaste vertrekpunt voor materiaal en contact. De nieuwsberichten vullen dat aan met actualiteit: een nieuwe single, een release-show of extra context rond het live-programma. Samen geeft dat een completer beeld van waar Bohèm op dat moment mee bezig is.",
      "Voor wie snel verder wil, zijn de belangrijkste routes dan ook duidelijk: persmateriaal op één plek, live-ingangen per setting en een nieuwspagina die recente momenten van wat extra achtergrond voorziet. Dat maakt Bohèm niet alleen makkelijker te volgen, maar ook eenvoudiger te plaatsen voor wie over publicatie, programmering of boeking beslist."
    ],
    image: {
      src: "/images/bohem-hero.jpg",
      alt: "Arthur Bont en Bettina Kraaieveld in warm podiumlicht",
